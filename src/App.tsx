                        ...
                        <Table className={settings.tableDensity === 'compact' ? 'text-sm' : ''}>
                          <TableHeader className="bg-slate-50/80 dark:bg-slate-800/80 sticky top-0">
                            <TableRow>
                              ...
                              <TableHead className="min-w-64 font-semibold">Executable Path</TableHead>
                              ...
                              <TableHead className="text-center w-48 font-semibold">Actions</TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {rows}
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg border">
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          ...
                          <span className="ml-2 text-slate-900 truncate">{confirmDialog?.processName}</span>
                        </div>
                      </div>
                    </div>
